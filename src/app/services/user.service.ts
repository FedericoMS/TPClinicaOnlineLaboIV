    ...
    this.user$ = this.authFire.authState.subscribe(async (user) => {
       if(user != null && user != undefined && user.emailVerified)
       {
         ...
         if (userProfileSnapshot.exists) {
           ...
           if(this.userProfile == "especialista" && this.usuarioActual.aprobado)
           {
            console.log("hola, if especialista. Estoy aprobado? " + this.usuarioActual.aprobado);
